...
The script accepts lists of genetic variants, designs probes (REF / ALT alleles and  Fwd/ Rev orientations) and outputs a text file of sequences that can be sent directly for oligo synthesis. 
MPRA simultaneously assesses the enhancer / promoter activity of hundreds or thousands of DNA sequences. MPRA can be used to assess the influence small genetic polymorphisms (SNPs / indels) on enhancer activity for genetic variants linked to trait, for example from a GWAS study. This script accepts a list of SNP/Indels and designs probes to be used in an MRPA experiment such as (https://www.nature.com/articles/s41596-020-0333-5). Users can set their own probe length, adapter sequence and other features such as removing/including indels. 
